    ...
    return PluginViewController.extend("sap.custom.plugins.integrationextension.controller.MainView", {
        ...
        onGetDetailsButtonPress: function(oEvent){
            ...
            if (shopOrder != null){
                ...
                var url =  'https://0301215ftrial-dev-podplugins.cfapps.us10-001.hana.ondemand.com/customapi/createTables';
                var that=this;
                this.getPodController()._oPodController.ajaxGetRequest(url, undefined,
                    function(oResponseData) {
